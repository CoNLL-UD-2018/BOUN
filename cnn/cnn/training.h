...
struct SimpleSGDTrainer : public Trainer {
  explicit SimpleSGDTrainer(Model* m, real lam = 1e-6, real e0 = 0.13) : Trainer(m, lam, e0) {}
...
struct AdamTrainer : public Trainer {
  explicit AdamTrainer(Model* m, float lambda = 1e-7, float alpha = 0.1, float beta_1 = 0.9, float beta_2 = 0.9, float eps = 1e-4) :
